...
function runKind(run: ProjectBoardRun): string { return run.kind === 'follow_up' || run.planningFollowUp ? 'Conversation' : run.kind === 'board_plan' ? 'Project planning' : run.kind === 'plan' ? 'Feature planning' : 'Feature work' }
