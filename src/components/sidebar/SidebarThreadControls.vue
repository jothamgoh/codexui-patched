...
.sidebar-thread-controls-button {
  @apply h-7 w-7 rounded-lg border border-transparent bg-transparent text-zinc-500 flex items-center justify-center transition hover:bg-zinc-200/80 hover:text-zinc-800;
}
